...
from twistr.epitope_selection.epitope_viz.config import load_epitope_viz_config
...
from twistr.epitope_selection.stages import hotspot, masif, scannet, viz
from twistr.epitope_selection.stages.common import (
    derive_pdb_ids, write_diagnostics, write_parquet,
)
from twistr.epitope_selection.stages.context import PipelineContext
...
def _build_context(cfg: PipelineConfig, pdb_list_path: Path | None) -> PipelineContext:
    ...
    work_root = Path(sub["epitopes"].get("work_dir", "runtime/data/epitopes/work"))
