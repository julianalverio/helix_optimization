...
from twistr.pipeline._cache import is_valid as _cache_valid, mark as _cache_mark, signature as _cache_signature
from twistr.pipeline.hotspot_filter.filter import filter_patches_for_pdb
from twistr.pipeline.scannet_filter.filter import parse_residue_id
...
def run_batch(ctx: PipelineContext) -> None:
    ...
    from twistr.pipeline.manager.modal_app import app, run_critires
