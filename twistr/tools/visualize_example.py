...
By default, walks the entire `data/module3/examples/` tree in a randomly
...
Usage:
    python -m twistr.tools.visualize_example                                   # random examples, Enter for next
    python -m twistr.tools.visualize_example --all                             # same, full cropped context
    python -m twistr.tools.visualize_example --seed 7                          # reproducible random order
    python -m twistr.tools.visualize_example data/module3/examples/br/1brs_1_0.npz   # specific example
    python -m twistr.tools.visualize_example data/module3/examples/br/1brs_1_*.npz   # specific set
"""
...
from ..pipeline.tensors.constants import ATOM14_SLOT_NAMES, RESIDUE_TYPE_NAMES
...
def main() -> None:
    ...
    parser.add_argument(
        "--examples-root", type=Path, default=Path("data/module3/examples"),
        help="Where to look for examples when no explicit npz paths are given.",
    )
    parser.add_argument(
        "--module1-manifest", type=Path,
        default=Path("data/manifests/module1_manifest.parquet"),
    )
    parser.add_argument(
