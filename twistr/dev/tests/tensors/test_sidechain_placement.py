...
from twistr.pipeline.models.sidechain import (
    ATOM14_CHI_DEPTH,
    ATOM14_USED_MASK,
...
def test_chi_depth_consistency_with_chi_tuples():
    ...
    from twistr.tensors.constants import ATOM14_SLOT_INDEX
    from twistr.pipeline.features.chi_angles import _CHI_ANGLES_ATOMS
