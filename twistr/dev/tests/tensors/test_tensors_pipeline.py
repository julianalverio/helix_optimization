...
from twistr.tensors.pipeline import process_entry
from twistr.tensors.tensors import build_atom14, serialize_npz

FIXTURE_DIR = Path(__file__).parent.parent / "fixtures" / "mmCIF"
...
@pytest.mark.skip(reason="1A3N currently dropped by the tensors pipeline; investigate separately")
