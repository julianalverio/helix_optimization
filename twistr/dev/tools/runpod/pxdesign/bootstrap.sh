...
# Prewarm path: dev/tools/runpod/pxdesign/prewarm.py sets PXD_SETUP_ONLY=1 to
...
python -m twistr.dev.tools.runpod.pxdesign.run_pxdesign --config runtime/configs/pxdesign.yaml
