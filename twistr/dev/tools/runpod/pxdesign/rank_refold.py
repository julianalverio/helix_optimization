...
Reads `refold_runtime/outputs/<pod_label>/<design_name>/<dataset>/<sample>/seed_*/predictions/`
which contains:
...
Usage:
  python -m twistr.dev.tools.runpod.pxdesign.rank_refold \\
      --refold-dir refold_outputs \\
      --face-prefix 3erd_b2 \\
      --out runtime/outputs/rankings/face1_refold.csv
"""
