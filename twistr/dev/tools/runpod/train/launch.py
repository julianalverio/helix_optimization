...
TRAIN_CONFIG = REPO_ROOT / "runtime/configs/ml.yaml"

# Persistent network volume holding the dataset (runtime/data/examples/). Pod creation
...
# `tar | ssh` into /data — see dev/tools/runpod/train/README in repo history.
...
bash /workspace/twistr/dev/tools/runpod/train/bootstrap.sh 2>&1 | tee /workspace/twistr/train.log
EOF
