...
Usage:
  python -m twistr.dev.tools.runpod.boltzgen.score_designs \\
      --hotspots 44,48,51,52,55,59 \\
      --metrics-csv runtime/outputs/boltzgen_runtime/outputs/face1/face1/final_ranked_designs/final_designs_metrics_50.csv \\
      --cifs runtime/outputs/boltzgen_runtime/outputs/face1/face1/final_ranked_designs/final_50_designs/rank*.cif \\
      --out runtime/outputs/scoring/face1.csv
"""
...
from twistr.tensors.dssp import run_dssp
