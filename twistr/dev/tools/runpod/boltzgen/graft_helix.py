...
Usage:
  python -m twistr.dev.tools.runpod.boltzgen.graft_helix \\
      --helix-pdb runtime/outputs/cropped/face1_best.pdb --helix-chain A --helix-resi 20-29 \\
      --scaffold-pdb ~/Desktop/helical_sdAb_scaffold_examples/93ite.pdb \\
      --scaffold-chain A --scaffold-resi 13-22 \\
      --out runtime/outputs/grafted/face1_into_93ite.pdb
"""
