...
Usage:
  python -m twistr.dev.tools.runpod.boltzgen.crop_best_helix \\
      --scoring runtime/outputs/scoring/face1.csv \\
      --hotspots 44,48,51,52,55,59 \\
      --out runtime/outputs/cropped/face1_best.pdb
"""
...
def main() -> None:
    ...
    # SS8 code 0 == H per twistr.tensors.constants.SS8_CODES.
