#!/usr/bin/env bash
# Pod-side bootstrap. The repo (incl. submodules + tools/runpod_smoke_test/subset/
...
python -m twistr.ml.training.train --config tools/runpod_smoke_test/config_smoke.yaml
