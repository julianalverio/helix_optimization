...
Output: `twistr/ml/losses/_dunbrack_library.npz` with arrays
...
if __name__ == "__main__":
    ...
    ap.add_argument("--dataset", default="data/dunbrack/DatasetForBBDepRL2010.txt")
    ap.add_argument(
        "--output",
        default="twistr/ml/losses/_dunbrack_library.npz",
