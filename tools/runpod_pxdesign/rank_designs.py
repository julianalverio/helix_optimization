...
Usage:
  python -m tools.runpod_pxdesign.rank_designs \\
      --config config_pxdesign.yaml \\
      --inputs design_outputs/3erd_b2_a design_outputs/3erd_b2_b ... \\
      --out rankings/face1.csv
"""
...
from tools.runpod_pxdesign.config import TargetChain, load_pxdesign_config
...
def main() -> None:
    ...
    parser.add_argument("--inputs", type=Path, nargs="+", required=True,
                        help="Design output run directories (e.g. design_outputs/3erd_b2_a)")
