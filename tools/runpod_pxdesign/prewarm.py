...
Usage:
    python -m tools.runpod_pxdesign.prewarm --config config_pxdesign.yaml
...
from tools.runpod_pxdesign.config import load_pxdesign_config
    ...
    try:
        ...
        try:
            ...
            rc = _ssh_run_detached(
                host, port,
                "PXD_SETUP_ONLY=1 bash /workspace/twistr/tools/runpod_pxdesign/bootstrap.sh",
                label="prewarm",
