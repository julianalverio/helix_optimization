...
Usage:
  python -m tools.runpod_pxdesign.build_refold_inputs \\
      --target data/pdb/3ERD.cif \\
      --target-chain A \\
      --fasta rankings/designed_sequences.fasta rankings/designed_sequences_face1_rest.fasta rankings/designed_sequences_face2.fasta \\
      --out refold_inputs
"""
...
from tools.runpod_pxdesign.launch import MSA_CACHE_DIR, REPO_ROOT, msa_cache_key
