...
Outputs (written to --out-dir, default `mpnn_outputs/`):
  - mpnn_outputs/pdbs/<flat_id>_dec<i>.pdb       — backbone copy with residues renamed
  - mpnn_outputs/decoded_sequences.fasta         — all N×K records, headers like
        >{flat_id}_dec{i}|score={mpnn_score}

Usage:
  python -m tools.runpod_pxdesign.sequence_design \\
      --inputs design_outputs/3erd_b2_a design_outputs/3erd_b2_b ... \\
      --num-decodings 8
"""
...
def _flat_id(pdb: Path) -> str:
    ...
    design_outputs/3erd_b2_b/.../seed_480288/.../sample_1.pdb
...
def main() -> None:
    ...
    parser.add_argument("--inputs", type=Path, nargs="+", required=True,
                        help="Run dirs under design_outputs/, e.g. design_outputs/3erd_b2_a")
