...
redesign them via Rosetta Remodel, reusing twistr.pipeline.linkers's
...
Usage:
  python -m tools.runpod_boltzgen.redesign_flanking_loops \\
      --pdb grafted/face1_into_93ite.pdb --chain A --helix-resi 13-22 \\
      --rosetta-python ~/.venv-rosetta/bin/python \\
      --out grafted/face1_into_93ite_redesigned.pdb
"""
...
from twistr.pipeline.linkers.remodel_runner import run_remodel
