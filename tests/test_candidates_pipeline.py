...
from twistr.pipeline.curation import candidates, rcsb
from twistr.pipeline.curation.obsolete import fetch_obsolete, parse_obsolete
...
def test_bogus_id_lands_in_audit_as_metadata_missing(tmp_path):
    ...
    from twistr.config import Config, snapshot_now
    from twistr import paths as mpaths
    ...
    import twistr.pipeline.curation.candidates as cand_mod
