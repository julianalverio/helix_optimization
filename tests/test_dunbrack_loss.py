...
from twistr.ml.losses.dunbrack import (
    _GENERAL_INDEX,
    _HELIX_INDEX,
    _LIBRARY_PATH,
    _load_library,
...
def test_quality_filter_drops_zero_rows_on_prefiltered_dataset():
    ...
    from tools.dunbrack.fit_rotamer_library import parse_dataset
    n = sum(1 for _ in parse_dataset(_LIBRARY_PATH.parent.parent.parent.parent / "data" / "dunbrack" / "DatasetForBBDepRL2010.txt"))
