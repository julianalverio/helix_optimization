...
from twistr.ml.features.chi_angles import (
    CHI_ATOM14_INDICES,
    _CHI_ANGLES_ATOMS,
    chi_mask,
    compute_chi_angles,
)
from twistr.pipeline.tensors.constants import (
    ATOM14_SLOT_INDEX,
    RESIDUE_TYPE_NAMES,
)
...
def test_sincos_round_trip():
    ...
    from twistr.ml.features.chi_angles import chi_sincos
...
def test_conditioning_chi_gating():
    ...
    from twistr.ml.features.chi_angles import chi_sincos
    from twistr.ml.features.conditioning import (
